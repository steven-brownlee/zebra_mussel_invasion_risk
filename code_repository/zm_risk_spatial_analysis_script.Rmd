...
outdir <- '/mnt/023ede0b-f66f-4769-939d-421b38967538/cci_lakes_rds/'
...
for (i in 1735:3470) {
  ...
  interior_data_filled <- coord_filling %>%
    ...
    replace(is.na(.), 0) %>% 
    mutate(na_test = chla_mean + chla_uncertainty  + lswt_uncertainty + lswt_quality_level  + lswt + turbidity_mean + turbidity_uncertainty + rw_443 + rw_443_u + rw_560 + rw_560_u) %>% 
    filter(na_test != 0)
